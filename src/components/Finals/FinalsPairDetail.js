...
function FinalsPairDetail() {
  ...
  return (
    <div className="container mt-4">
      ...
      <p><strong>Participant 2:</strong> {pair.participant2 ? pair.participant2.participant.name : 'No opponent'}</p>
      ...
      <p><strong>Winner:</strong> {pair.winner === pair.participant1.id ? pair.participant1.participant.name : pair.participant2 ? pair.participant2.participant.name : 'None'}</p>
